...
export default {
    name: 'comment', // allows component to be referenced within itself
    data() {
      return {
        item: {},
        kids: [],
    ...
    async beforeMount() { // asyncData not available within a Component file
